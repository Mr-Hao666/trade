$(function () {
    $("#jqGrid").jqGrid({
        ...
        colModel: [			
			...
			{ label: '市id', name: 'cityId', index: 'city_id', width: 80 }, 			
			{ label: '区id', name: 'areaId', index: 'area_id', width: 80 }, 			
			{ label: '详细地址', name: 'detailAddress', index: 'detail_address', width: 80 }, 			
			{ label: '创建时间', name: 'createTime', index: 'create_time', width: 80 }, 			
			{ label: '更新时间', name: 'updateTime', index: 'update_time', width: 80 }, 			
			{ label: '是否默认 0:否 1:是(同一个用户只能有一个默认地址)', name: 'isDefault', index: 'is_default', width: 80 }			
        ],
		viewrecords: true,
        height: 385,
        rowNum: 10,
