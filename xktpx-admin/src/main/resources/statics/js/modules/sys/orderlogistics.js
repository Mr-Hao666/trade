$(function () {
    $("#jqGrid").jqGrid({
        url: baseURL + 'sys/orderlogistics/list',
        datatype: "json",
        colModel: [			
...
var vm = new Vue({
	...
	methods: {
		...
		saveOrUpdate: function (event) {
			var url = vm.orderLogistics.id == null ? "sys/orderlogistics/save" : "sys/orderlogistics/update";
			$.ajax({
				type: "POST",
			    url: baseURL + url,
		...
		del: function (event) {
			...
			confirm('确定要删除选中的记录？', function(){
				$.ajax({
					type: "POST",
				    url: baseURL + "sys/orderlogistics/delete",
                    contentType: "application/json",
		...
		getInfo: function(id){
			$.get(baseURL + "sys/orderlogistics/info/"+id, function(r){
