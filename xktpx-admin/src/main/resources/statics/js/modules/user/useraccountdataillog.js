$(function () {
    $("#jqGrid").jqGrid({
        ...
        colModel: [			
			...
			{ label: '变动类型 1:退换至微信 2:定金退回 3:支付保证金 4:微信转账...', name: 'changeType', index: 'change_type', width: 80 }, 			
			{ label: '变动金额', name: 'changeMoney', index: 'change_money', width: 80 }, 			
			{ label: '变动前金额', name: 'beforeChangeMoney', index: 'before_change_money', width: 80 }, 			
