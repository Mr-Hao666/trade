...
var vm = new Vue({
	...
	methods: {
		...
		saveOrUpdate: function (event) {
			var url = vm.token.userId == null ? "user/token/save" : "user/token/update";
			$.ajax({
				type: "POST",
			    url: baseURL + url,
		...
		getInfo: function(userId){
			$.get(baseURL + "user/token/info/"+userId, function(r){
                vm.token = r.token;
            });
		},
