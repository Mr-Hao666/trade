 ...
 */
@RestController
@RequestMapping("sys/ordergoodsdetail")
public class OrderGoodsDetailController {
     ...
     */
    @RequestMapping("/list")
    @RequiresPermissions("sys:ordergoodsdetail:list")
    ...
    @RequiresPermissions("sys:ordergoodsdetail:info")
     ...
     */
    @RequestMapping("/save")
    @RequiresPermissions("sys:ordergoodsdetail:save")
    ...
    @RequiresPermissions("sys:ordergoodsdetail:update")
    ...
    @RequiresPermissions("sys:ordergoodsdetail:delete")
