 ...
 */
@RestController
@RequestMapping("sys/goodsrecbanner")
public class GoodsRecBannerController {
     ...
     */
    @RequestMapping("/list")
    @RequiresPermissions("sys:goodsrecbanner:list")
    ...
    @RequiresPermissions("sys:goodsrecbanner:info")
     ...
     */
    @RequestMapping("/save")
    @RequiresPermissions("sys:goodsrecbanner:save")
    ...
    @RequiresPermissions("sys:goodsrecbanner:update")
    ...
    @RequiresPermissions("sys:goodsrecbanner:delete")
