...
public class GoodsSizeController {
     ...
     */
    @RequestMapping("/list")
    @RequiresPermissions("sys:goodssize:list")
    ...
    @RequiresPermissions("sys:goodssize:info")
     ...
     */
    @RequestMapping("/save")
    @RequiresPermissions("sys:goodssize:save")
    ...
    @RequiresPermissions("sys:goodssize:update")
    ...
    @RequiresPermissions("sys:goodssize:delete")
